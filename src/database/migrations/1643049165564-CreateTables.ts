...
export class CreateTables1643049165564 implements MigrationInterface {
    name = 'CreateTables1643049165564'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "games" ("id" SERIAL NOT NULL, "game_number" integer NOT NULL, "classification" character varying NOT NULL, "user_id" integer NOT NULL, "user_name" character varying NOT NULL, "points" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`);
